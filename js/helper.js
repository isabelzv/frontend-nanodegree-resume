...
var HTMLwebSite = '<li class="flex-item"><span class="darkgrey-text">web</span><span class="blue-text"><a class="weblink" href="%data%">%data%</a></span></li>';
...
var HTMLworkEmployer = '<a href="%link%">%data%</a>';
